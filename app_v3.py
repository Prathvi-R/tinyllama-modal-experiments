...
#
# Goal:
# - Keep the warm-container class design from v2
# - Clean up warnings
# - Add basic timing so cold-start vs warm-request behavior is measurable
# - Stay simple and cheap enough for a $30/month budget
# =============================================================================
...
app = modal.App(name="tinyllama-qa-v3", image=image)
...
def main(question: str = ""):
    print("=" * 60)
    print("  TinyLlama Q&A v3 — Modal + Hugging Face")
    print("=" * 60)
